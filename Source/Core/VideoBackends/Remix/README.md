...
- **Changes take effect at backend init**, i.e. when emulation starts. Restart
  the game after editing. The exceptions are fourteen knobs that are re-read at
  ...
  `RemixUiStrict` and `RemixUiDepth`.
